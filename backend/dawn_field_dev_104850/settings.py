"""
Django settings for dawn_field_dev_104850 project.
...
ROOT_URLCONF = 'dawn_field_dev_104850.urls'
...
WSGI_APPLICATION = 'dawn_field_dev_104850.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dawn_field_dev_104850 API",
    "DESCRIPTION": "API documentation for dawn_field_dev_104850 App",
    "VERSION": "v1",
}
